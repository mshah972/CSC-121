...
int main()
{
    ...
    int accountNumber = umlClass.getId();                                                                   // int variable accountNumber
    int userNumber;             
    ...
    cout << "\n\tREMEMBER YOUR ACCOUNT NUMBER: " << accountNumber << endl;                                  // display account number
    ...
    if(quit == 'y')
    {
        system("cls");
        cout << "\n\n\tWelcome " << umlClass.name << "!" << endl;                                           // welcome user
        cout << "\nPLEASE ENTER YOUR ACCOUNT NUMBER: ";                                                     // prompt user for account number
        cin >> userNumber;                                                                                  // get account number from user

        cout << "\n\n\tTHANKS FOR ENTERING YOUR ACCOUNT NUMBER!" << endl;                                   // thank user for entering account number
    }
